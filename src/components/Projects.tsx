...
const projects = [
  {
    ...
    techTags: ["Next.js", "Base de Datos", "Autenticación", "Panel Admin"],
    businessTags: ["Catálogo 24/7", "Autoadministrable", "Gestión de Stock"],
  ...
  },
  {
    ...
    techTags: ["React", "UI/UX", "Formularios Dinámicos"],
    businessTags: ["Captación de Clientes", "Sistema de Citas", "Imagen Profesional"],
  ...
  },
  {
    ...
    techTags: ["React", "Diseño Web", "Optimización"],
    businessTags: ["Tienda Online", "Pedidos Fáciles", "Diseño Atractivo"],
  ...
  },
  {
    ...
    techTags: ["Python", "Data Science", "SQL", "React"],
    businessTags: ["Análisis de Ventas", "Toma de Decisiones", "Métricas en Tiempo Real"],
    link: "#",
...
export default function Projects({ variant = "business" }: ProjectsProps) {
  return (
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="space-y-24 md:space-y-32">
          {projects.map((project, idx) => {
            const tagsToShow = variant === "tech" ? project.techTags : project.businessTags;
            return (
              <motion.div 
                key={idx}
                initial={{ opacity: 0, y: 40 }}
              ...
              >
                ...
                <div className={`w-full md:w-1/2 ${idx % 2 === 1 ? 'md:order-2' : ''}`}>
                  ...
                  <ul className="flex flex-wrap gap-3 mb-8">
                    {tagsToShow.map((t, i) => (
                      <li key={i} className={`font-mono text-sm border px-4 py-2 rounded-full ${
                        variant === 'tech' 
